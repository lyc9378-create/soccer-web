...
// Vercel Serverless Function - Standings
app.get('/api/standings/:leagueId', async (req, res) => {
    try {
        ...
        const url = `https://site.api.espn.com/apis/v2/sports/soccer/${espnId}/ const response = await axios.get(url, { timeout: standings`;
       10000 });
...
// Vercel Serverless Function - Scorers
...
// Vercel Serverless Function - Assists
